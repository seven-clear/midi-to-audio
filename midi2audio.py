...
class FluidSynth():
    ...
    def midi_to_audio(self, midi_file, audio_file, sample_rate=DEFAULT_SAMPLE_RATE):
        cmd = f"fluidsynth -ni -F {audio_file} -r {str(sample_rate)} {self.sound_font} {midi_file}"
        os.system(cmd)
